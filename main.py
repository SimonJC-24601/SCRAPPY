...
from src.routes.scraped_data import scraped_data_bp
from src.routes.admin import admin_bp
from src.routes.site_content import site_content_bp
from src.routes.scraper import scraper_bp

app = Flask(__name__, static_folder=os.path.join(os.path.dirname(__file__), 'static'))
app.config['SECRET_KEY'] = 'source-code-scraper-secret-key-2024'
...
app.register_blueprint(scraped_data_bp, url_prefix='/api')
